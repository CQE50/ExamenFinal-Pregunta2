...
namespace Pregunta03
{
    public partial class FrmPregunta02 : Form
    {
        ...
        private void button13_Click(object sender, EventArgs e)
        {
            Bitmap bmp = new Bitmap(imagen.Image);
            //binarizando imagen
            AForge.Imaging.Filters.Threshold  filtro0 = new AForge.Imaging.Filters.Threshold();
            System.Drawing.Bitmap imagenbinarizada = filtro0.Apply(bmp);
            imagen3.Image = imagenbinarizada;
            //conviertiendo
            AForge.Imaging.Filters.ConnectedComponentsLabeling filtro1 = new AForge.Imaging.Filters.ConnectedComponentsLabeling();
            System.Drawing.Bitmap imagensegmentada = filtro1.Apply(imagenbinarizada);
            imagen2.Image = imagensegmentada ;
